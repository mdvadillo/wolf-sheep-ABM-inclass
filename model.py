...
from wolf_sheep.agents import Sheep, Wolf, GrassPatch, Lawnmower
...
class WolfSheep(mesa.Model):
    ...
    def __init__(
        ...
        self.initial_lawnmowers = initial_lawnmowers
        ...
        # Create lawnmowers:
        for i in range(self.initial_lawnmowers):
            x = self.random.randrange(self.width)
            y = self.random.randrange(self.height)
            lawnmower = Lawnmower(self.next_id(), (x, y), self, True)
            self.grid.place_agent(lawnmower, (x, y))
            self.schedule.add(lawnmower)
